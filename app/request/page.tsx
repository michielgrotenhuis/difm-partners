...
export default function RequestWizard() {
  ...
  const steps = [
    { id: 1, title: 'Website Goal', icon: SparklesIcon, component: WizardStep1 },
    { id: 2, title: 'Business Info', icon: DocumentTextIcon, component: WizardStep2 },
    { id: 3, title: 'Features', icon: PaintBrushIcon, component: WizardStep3 },
    { id: 4, title: 'Content', icon: DocumentTextIcon, component: WizardStep4 },
    { id: 5, title: 'Design', icon: PaintBrushIcon, component: WizardStep5 },
    { id: 6, title: 'Domain', icon: DocumentTextIcon, component: WizardStep6 },
    { id: 7, title: 'Budget & Timeline', icon: CurrencyEuroIcon, component: WizardStep7 },
    { id: 8, title: 'Contact Info', icon: UserIcon, component: WizardStep8 },
  ]
  ...
  const canProceed = () => {
    switch (currentStep) {
      case 1:
        return !!formData.websiteGoal
      case 2:
        return formData.businessInfo.length > 10 && !!formData.businessName
      case 3:
